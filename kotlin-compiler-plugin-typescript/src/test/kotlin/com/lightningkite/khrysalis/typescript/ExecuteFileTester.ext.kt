...
fun ExecuteFileTester.kotlinAndTs(file: File): KatResult {
    ...
    val kResult = kotlin(file) {
        ...
        pluginOptions += listOf(
            PluginOption(KotlinTypescriptCLP.PLUGIN_ID, KotlinTranspileCLP.KEY_EQUIVALENTS_NAME, listOf(File("../jvm-runtime/src"), outFolder.resolve("../testReplacements")).joinToString(File.pathSeparator)),
