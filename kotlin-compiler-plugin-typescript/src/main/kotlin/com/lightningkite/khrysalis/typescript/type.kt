        ...
        action = {
            ...
            when {
                resolvedType.isInterface() -> {
                    out.addImport("butterfly/dist/Kotlin", "tryCastInterface")
                    -"tryCastInterface<"
                    -typedRule.right
                    -">("
                    -typedRule.left
                ...
                resolvedType.isPrimitive() -> {
                    out.addImport("butterfly/dist/Kotlin", "tryCastPrimitive")
                    -"tryCastPrimitive<"
                    -typedRule.right
                    -">("
                    -typedRule.left
                    ...
                    out.addImport("butterfly/dist/Kotlin", "tryCastClass")
                    -"tryCastClass<"
                    -typedRule.right
                    -">("
                    -typedRule.left
...
fun PartialTranslatorByType<TypescriptFileEmitter, Unit, Any>.ContextByType<*>.emitIsExpression(
    ...
    when {
        resolvedType.isInterface() -> {
            out.addImport("butterfly/dist/Kotlin", "checkIsInterface")
            -"checkIsInterface<"
            -resolvedType
            -">("
            -expression
