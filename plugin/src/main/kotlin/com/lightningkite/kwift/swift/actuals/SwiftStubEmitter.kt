package com.lightningkite.kwift.swift.actuals

import com.lightningkite.kwift.flow.CodeSection
import com.lightningkite.kwift.flow.section
import com.lightningkite.kwift.flow.sectionPermanent
...
class SwiftStubEmitter(val swiftAltListener: SwiftAltListener, val out: TabWriter) {
    init {
        out.line("//Stub file made with Kwift 2 (by Lightning Kite)")
        out.line("import Foundation")
        out.line("")
    }
...
fun File.stubs(swift: SwiftAltListener, to: File) {
    ...
    try {
        ...
        val result = buildString {
            SwiftStubEmitter(swift, TabWriter(this)).handleKotlinFile(parser.kotlinFile())
        }
