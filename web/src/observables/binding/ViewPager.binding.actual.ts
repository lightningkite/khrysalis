...
import { comLightningkiteKhrysalisObservablesObservablePropertySubscribeBy as opSubBy } from '../ObservableProperty.ext.shared'
...
export function androidxViewpagerWidgetViewPagerBindStatic<T>(
    ...
    ioReactivexDisposablesDisposableUntil(opSubBy(showIndex, undefined, undefined, (it)=>{
...
//! Declares com.lightningkite.khrysalis.observables.binding.bind>androidx.viewpager.widget.ViewPager
export function androidxViewpagerWidgetViewPagerBind<T>(
    this_: HTMLDivElement,
    ...
    ioReactivexDisposablesDisposableUntil(opSubBy(items, undefined, undefined, (newItems)=>{
