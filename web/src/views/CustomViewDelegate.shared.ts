...
// FQImport: com.lightningkite.khrysalis.views.CustomViewDelegate.<init>.<anonymous>.it TS it
...
// FQImport: com.lightningkite.khrysalis.views.CustomViewDelegate._removed TS _removed
...
export abstract class CustomViewDelegate {
    ...
    if(temp181 !== null) customViewInvalidate(temp181); }
    public postInvalidate(): void { const temp182 = this.customView;
    if(temp182 !== null) customViewInvalidate(temp182); }
