...
export function androidWidgetTextViewBindString(this_: HTMLDivElement, observable: ObservableProperty<string>): SubscriptionLike{
...
export function androidWidgetTextViewBindStringRes(this_: HTMLDivElement, observable: ObservableProperty<(StringResource | null)>): SubscriptionLike{
    ioReactivexDisposablesDisposableUntil(comLightningkiteKhrysalisObservablesObservablePropertySubscribeBy(observable, undefined, undefined, (value) => {
...
export function androidWidgetTextViewBindText<T>(this_: HTMLDivElement, observable: ObservableProperty<T>, transform: (a: T) => string): SubscriptionLike{
    ioReactivexDisposablesDisposableUntil(comLightningkiteKhrysalisObservablesObservablePropertySubscribeBy(observable, undefined, undefined, (value) => {
