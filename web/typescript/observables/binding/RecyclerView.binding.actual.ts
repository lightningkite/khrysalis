...
// FQImport: androidx.recyclerview.widget.RecyclerView.adapter TS getAndroidxRecyclerviewWidgetRecyclerViewAdapter
// FQImport: androidx.recyclerview.widget.RecyclerView.adapter TS setAndroidxRecyclerviewWidgetRecyclerViewAdapter
...
// FQImport: androidx.recyclerview.widget.RecyclerView.layoutManager TS setAndroidxRecyclerviewWidgetRecyclerViewLayoutManager
...
export function androidxRecyclerviewWidgetRecyclerViewBind<T>(this_: RecyclerView, data: ObservableProperty<Array<T>>, defaultValue: T, makeView: (a: ObservableProperty<T>) => HTMLElement): void{
    ...
    setAndroidxRecyclerviewWidgetRecyclerViewAdapter(this_, new class Anon extends RecyclerView.RecyclerView<> {
            ...
            onBindViewHolder(holder: RecyclerView.ViewHolder, position: number): void{
                ...
                })((tryCastClass<StandardObservableProperty<T>>(getAndroidViewViewTag(holder.itemView), StandardObservableProperty))) ?? ((this_1) => {
...
export function androidxRecyclerviewWidgetRecyclerViewBindMulti(this_: RecyclerView, viewDependency: ViewDependency, data: ObservableProperty<Array<any>>, typeHandlerSetup: (a: RVTypeHandler) => void): void{
    ...
    setAndroidxRecyclerviewWidgetRecyclerViewAdapter(this_, new class Anon extends RecyclerView.RecyclerView<> {
            ...
            onBindViewHolder(holder: RecyclerView.ViewHolder, position: number): void{
                ...
                })((tryCastClass<MutableObservableProperty<any>>(getAndroidViewViewTag(holder.itemView), MutableObservableProperty))) ?? ((this_1) => {
                        console.log("Failed to find property to update")
                })(this);
            }
    }());
