...
function comLightningkiteKhrysalisCodableToJsonHttpBody(this_) {
    return new HttpBody(JSON.stringify(this), HttpMediaType_actual_1.HttpMediaTypes.INSTANCE.JSON);
}
exports.comLightningkiteKhrysalisCodableToJsonHttpBody = comLightningkiteKhrysalisCodableToJsonHttpBody;
