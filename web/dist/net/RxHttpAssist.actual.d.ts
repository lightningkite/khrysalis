...
export declare function ioReactivexSingleDiscard(this_: Observable<Response>): Observable<void>;
...
export declare function okhttp3ResponseDiscard(this_: Response): Observable<void>;
