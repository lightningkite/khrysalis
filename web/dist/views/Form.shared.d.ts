...
export declare class UntypedFormFieldDefaults {
}
...
export declare function comLightningkiteKhrysalisViewsFormFieldMatches<T extends object>(this_: FormField<T>, other: FormField<T>): (ViewString | null);
