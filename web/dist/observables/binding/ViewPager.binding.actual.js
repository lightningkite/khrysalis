...
function androidxViewpagerWidgetViewPagerBind(this_, items, _default, showIndex = new StandardObservableProperty_shared_1.StandardObservableProperty(0, undefined), makeView) {
    ...
    DisposeCondition_actual_1.ioReactivexDisposablesDisposableUntil(ObservableProperty_ext_shared_1.comLightningkiteKhrysalisObservablesObservablePropertySubscribeBy(items, undefined, undefined, (newItems) => {
