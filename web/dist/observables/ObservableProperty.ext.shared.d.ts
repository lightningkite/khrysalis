...
export declare function comLightningkiteKhrysalisObservablesObservablePropertyWhileActive(this_: ObservableProperty<boolean>, action: (() => SubscriptionLike)): SubscriptionLike;
