...
export declare class FlatMappedObservableProperty<A, B> extends ObservableProperty<any> {
...
export declare class MutableFlatMappedObservableProperty<A, B> extends MutableObservableProperty<any> {
    readonly basedOn: ObservableProperty<A>;
