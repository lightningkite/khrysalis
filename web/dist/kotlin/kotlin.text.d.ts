...
export declare function kotlinStringTrimIndent(c: string): string;
...
export declare function kotlinCharSequenceIndexOfAny(c: string, set: Array<string>, start: number, caseSensitive: boolean): number;
