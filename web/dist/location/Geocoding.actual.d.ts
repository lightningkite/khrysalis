...
export declare function comLightningkiteKhrysalisAndroidActivityAccessGeocode(this_Geocode: Window, coordinate: GeoCoordinate | string, maxResults?: number): Observable<Array<GeoAddress>>;
