...
fun ExecuteFileTester.kotlinAndSwift(file: File): KasResult {
    ...
    val kotlinOut = kotlin(file) {
        ...
        pluginOptions += listOf(
            PluginOption(KotlinSwiftCLP.PLUGIN_ID, KotlinTranspileCLP.KEY_EQUIVALENTS_NAME, swiftTestDir.resolve("Sources/KhrysalisRuntime").toString() + ":" + swiftTestDir.resolve("testReplacements").toString()),
